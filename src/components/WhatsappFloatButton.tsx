...
const WhatsappFloatButton: React.FC<WhatsappFloatButtonProps> = () => {
  return (
    <div>
      <a
        style={{ color: 'white' }}
        href="https://api.whatsapp.com/send/?phone=19187801300&text=Hello,%20i%20am%20interested%20in%20the%20services%20provided%20by%20Elizabeth%20Mende%20Brown%20and%20would%20like%20to%20know%20more."
