...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://advisor.elizabethmendebrown.com';
const SITE_NAME = process.env.NEXT_PUBLIC_SITE_NAME || 'Elizabeth Mende Brown';
